...
<header>
    ...
    <div style="width: 60% ;height:75%;padding-right:10px">
        <Bpf></Bpf>
    </div>
    捕获数量:<input type="number" min=1 max=10240 bind:value={max_packets} on:input={() =>{packets_limit.set(max_packets)}} style="height: 85% ;width:15%;font-size:16px ;border:1px solid ; border-radius:5px;padding-left: 10px;">
</header>
<main>
    {#if adapters}
